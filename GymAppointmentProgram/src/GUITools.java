...
{
	/**
	 * the 4 below methods sorts the course by name/date/time and number of people enrolled
	 */
    ...
    /**
     * Creates a dropdown menu that is used constantly throughout the program to sort courses
     * @param courses
     * @param tableModel
     * @param enrolledCourses
     * @return
     */
    public static JComboBox<String> createDropdownMenu(ArrayList<Course> courses, DefaultTableModel tableModel, ArrayList<Course> enrolledCourses) {
        ...
        sortingComboBox.addActionListener(e -> {
            ...
            if (selectedOption != null) {
                switch (selectedOption) {
                    case "Sort by Name":
                        sortCoursesByName(enrolledCourses);
                        break;
                    case "Sort by Date":
                        sortCoursesByDate(enrolledCourses);
                        break;
                    case "Sort by Time":
                        sortCoursesByTime(enrolledCourses);
                        break;
                    case "Sort by Enrolled":
                        sortCoursesByEnrolled(enrolledCourses);
                        break;
                }
                populateCourseTable(tableModel, enrolledCourses);
            }
        });
    ...
    /**
	 * Exception methods for course creation
	 */
    ...
    /**
	 * Checks username and password for illegal characters and empty fields
	 */
