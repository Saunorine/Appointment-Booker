...
public class EnrolledCoursesPage extends JFrame {
    ...
    public EnrolledCoursesPage(Account account, LoggedInPage loggedInPage) {
        ...
        /**
    	 * The part that shows tableModel data in an excel-like fashion
    	 */
    	 ...
    	 */
        JComboBox<String> sortingComboBox = GUITools.createDropdownMenu(enrolledCourses, tableModel, enrolledCourses);
